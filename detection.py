...
real_world_testpath = '/beegfs/project/bmbf-need/spectral-analysis/cnn-spectral-analysis/data/Impact_Echo_Machine_Learning/database_autoencoder/new_approach' #'/beegfs/project/bmbf-need/spectral-analysis/cnn-spectral-analysis/data/database_autoencoder/real_world_measured/'
...
for subdir in os.listdir(real_world_testpath):
    ...
    if subdir.lower().startswith('realworld'):
        ...
        if os.path.isdir(full_subdir_path):
            ...
            detection_folder = f'{model_folder}/detection_plot/{subdir}'
